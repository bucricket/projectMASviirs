...
def write_color_table(minVal,maxVal,numColors,fileName):
    ...
    file = open(fn, "w")
    file.write("-9999. 1 1 1 0\n")
    file.write("%f 255 0 0 255\n" % (colorVals[0]/100.))
    file.write("%f 255 69 0 255\n" % (colorVals[1]/100.))
    file.write("%f 255 255 0 255\n" % (colorVals[2]/100.))
    file.write("%f 0 128 0 255\n" % (colorVals[3]/100.))
    file.write("%f 30 144 255 255\n" % (colorVals[4]/100.))
    file.write("%f 0 0 139 255\n" % (colorVals[5]/100.))
    file.write("%f 75 0 130 255\n" % (colorVals[6]/100.))
    file.close()
